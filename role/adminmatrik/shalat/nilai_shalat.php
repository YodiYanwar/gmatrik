                          ...
                          <h2><a href="?page=pekanshalat" class="btn btn-sm btn-link waves-effect" title="Kembali"><i class="material-icons">arrow_back</i></a>&nbsp;&nbsp;&nbsp;NILAI PRESENSI SHALAT
                            <small>Pekan ke :
                                <div class="btn-group">
                                              ...
                                              <span class="caret"></span>
                                                      ...
                                                      <ul class="dropdown-menu">
                                                          <?php
                                                            ...
                                                            ?>
                                                              <li><?php echo '<a href="?page=nilaishalat&idpekan='.$row['id_pekan'].'">'.$row['pekan'].') '.date('d M Y', strtotime($row['tanggal_dari'])).' - '.date('d M Y', strtotime($row['tanggal_sampai'])).'</a>'; ?>
                                                              </li>
                                                          <?php } ?>
                                                      </ul>
                                      </div>
                                      ...
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	                                      <a type="button" class="btn btn-default btn-sm" href="report/nilaishalatall.php?idpekan=<?php echo $idPekan; ?>" target="_blank">
